export default {
  ...
  'main.tokenSaleBox.subTitle': 'Private Sale Now',
  'main.tokenSaleBox.description': 'We’re currently in the private sale stage of funding. {newsletter} {or} {telegram} for all the latest updates!',
  'main.tokenSaleBox.newsletter': 'Sign up to our newsletter',
  'main.tokenSaleBox.telegram': 'join our telegram group',
  'main.subtitle': 'Scalable Blockchain All-in-One Solution for Social Game Creators',
  'main.read.whitepaper': 'Read our White Paper',
  'main.resource.business.intro': 'Business Intro v1.6',
  'main.resource.english.whitepaper': 'English Whitepaper v1.6',
  'main.resource.chinese.whitepaper': 'Chinese Whitepaper v1.6',
  'main.register.candy': 'Worldcup Prediction & Lottery!',
  ...
  'update.media.5.title': 'Artist Lu Sisi Join Ares as Art Director',
  'update.media.5.description': 'Exciting crossover from Art to Game to Blockchain',
  ...
  'upcomingEvents.event.GBLS.title': 'Global Blockchain Leadership Summit',
  'upcomingEvents.event.GBLS.date': '06.06.2018',
  'upcomingEvents.event.GBLS.location': 'Hangzhou, China',
  'upcomingEvents.event.TechOpenAir.title': 'Tech Open Air',
  'upcomingEvents.event.TechOpenAir.date': '20.06.2018',
  'upcomingEvents.event.TechOpenAir.location': 'Berlin, Germany',
  'upcomingEvents.event.Gamescom.title': 'Gamescom',
  'upcomingEvents.event.Gamescom.date': '21-23.08.2018',
  'upcomingEvents.event.Gamescom.location': 'Cologne, Germany',
  'upcomingEvents.event.TechCrunch.title': 'Ethereum Meetup by TechCrunch',
  'upcomingEvents.event.TechCrunch.date': '07.07.2018',
  'upcomingEvents.event.TechCrunch.location': 'Zug, Switzerland',
  'upcomingEvents.event.EthDappsConf.title': 'Ethereum Dapps & Infrastructure Conference',
  'upcomingEvents.event.EthDappsConf.date': '19-20.07.2018',
  'upcomingEvents.event.EthDappsConf.location': 'Berlin, Germany',
  'upcomingEvents.event.devcom.title': 'Devcom 2018 developer conference',
  'upcomingEvents.event.devcom.date': '19-20.08.2018',
  'upcomingEvents.event.devcom.location': 'Cologne, Germany',
  'media.title': 'Media',
